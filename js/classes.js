...
class fighter extends Sprite{ //graphics
    ...
    update(){
        ...
        this.position.y += this.velocity.y //will move 10px very frame
    ...
    switchSprite(sprite){
        ...
        //overridig animations with attack nimation
